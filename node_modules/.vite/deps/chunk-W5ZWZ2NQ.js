...
var TablePaginationActions = React2.forwardRef(function TablePaginationActions2(props, ref) {
  const {
    backIconButtonProps,
    count,
    disabled = false,
...
var TablePagination = React3.forwardRef(function TablePagination2(inProps, ref) {
  ...
  return (0, import_jsx_runtime3.jsx)(TablePaginationRoot, {
    colSpan,
    ref,
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ...other,
    children: (0, import_jsx_runtime3.jsxs)(TablePaginationToolbar, {
      ...
      }), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime3.jsx)(TablePaginationSelect, {
        variant: "standard",
        ...!selectProps.variant && {
...
//# sourceMappingURL=chunk-W5ZWZ2NQ.js.map
